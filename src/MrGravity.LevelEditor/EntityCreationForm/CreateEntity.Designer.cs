...
namespace MrGravity.LevelEditor.EntityCreationForm
{
    partial class CreateEntity
    {
        ...
        {
            var resources = new System.ComponentModel.ComponentResourceManager(typeof(CreateEntity));
        ...
        private ListBox lb_entitySelect;
        private Button b_createNew;
        private Label lbl_entitySelect;
        private ListBox lb_filter;
        private Label lbl_filter;
        private Label lbl_properties;
        private Label lbl_name;
        private Label lbl_type;
        private Label lbl_paintable;
        private TextBox tb_name;
        private ComboBox cb_type;
        private CheckBox ckb_paintable;
        private Button b_additional;
        private PictureBox pb_texture;
        private Button b_ok;
        private Button b_delete;
        private ComboBox cb_collisionType;
        private Label lbl_collisionType;
    }
}