...
namespace GravityShift
{
    class AfterScore
    {
        ...
        public void Draw(SpriteBatch spriteBatch, GraphicsDeviceManager graphics, Matrix scale)
        {
            ...
            spriteBatch.Draw(mTrans, new Vector2(graphics.GraphicsDevice.Viewport.TitleSafeArea.Left, graphics.GraphicsDevice.Viewport.TitleSafeArea.Top), Color.White); 
            ...
            spriteBatch.Draw(mItems[0], new Rectangle(graphics.GraphicsDevice.Viewport.TitleSafeArea.Center.X - (mItems[0].Width / 2),
                graphics.GraphicsDevice.Viewport.TitleSafeArea.Bottom - mItems[0].Height - 350,
            ...
            spriteBatch.Draw(mItems[1], new Rectangle(graphics.GraphicsDevice.Viewport.TitleSafeArea.Center.X - (mItems[1].Width / 2),
                graphics.GraphicsDevice.Viewport.TitleSafeArea.Bottom - mItems[1].Height - 275,
